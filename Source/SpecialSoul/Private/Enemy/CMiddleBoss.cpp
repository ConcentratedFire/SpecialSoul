...
ACMiddleBoss::ACMiddleBoss()
{
	...
	ConstructorHelpers::FObjectFinder<UAnimMontage> tmpAttackMontage(TEXT("/Script/Engine.AnimMontage'/Game/Asset/gromp/AM_MiddleBoseAttack.AM_MiddleBoseAttack'"));
	if (tmpAttackMontage.Succeeded())
		AttackMontage = tmpAttackMontage.Object;

	ConstructorHelpers::FObjectFinder<UAnimMontage> tmpDieMontage(TEXT("/Script/Engine.AnimMontage'/Game/Asset/gromp/AM_MiddleBossDie.AM_MiddleBossDie'"));
